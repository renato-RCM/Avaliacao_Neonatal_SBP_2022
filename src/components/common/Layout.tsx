    ...
    <div className="min-h-screen bg-slate-50">
      <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/95 backdrop-blur no-print">
        <div className="container-app flex items-center justify-between py-3">
          <Link to="/" className="flex items-center gap-2 text-slate-900 hover:text-clinical-700">
            <span className="grid h-9 w-9 place-items-center rounded-lg bg-clinical-600 text-white shadow-sm">
              <Stethoscope className="h-5 w-5" aria-hidden />
            </span>
            <div className="leading-tight">
              <div className="text-sm font-bold sm:text-base">Avaliação Neonatal</div>
              <div className="text-[10px] font-medium uppercase tracking-wide text-slate-500 sm:text-xs">
                SBP 2022
              </div>
            </div>
          </Link>
